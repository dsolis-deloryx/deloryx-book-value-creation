...
logic that governs how quickly a team can iterate toward fit. The discipline pre-dates the popular framing: \textcite{blank2005foursteps} articulated customer development as a parallel process to product development before \textcite{ries2011} popularised the lean label.
...
sequence. \textcite{cagan2018inspired}, the most-cited practitioner reference for modern product management, operationalises this cycle as a discovery-and-delivery cadence run by a product trio of product manager, designer, and engineer.
