...
Motivation theory connects directly to incentive design through the Kerr Trap: the right measure, correctly rewarded, can satisfy both the agency constraint (\cref{eq:agency-cost}) and the SDT conditions simultaneously. \textcite{robbins2022} synthesises the full literature; \textcite{kerr1975folly} remains the practitioner's caution. \textcite{grove1995high} remains the practitioner reference for operating-cadence design --- 1:1 cadence, output metrics, decision-making frameworks, and managerial leverage --- a complement to the academic incentive theory above.
