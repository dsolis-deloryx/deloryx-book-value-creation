...
\textcite{helmer2016powers} catalogues the same mechanisms as seven \emph{powers}: scale economies, network economies, counter-positioning, switching costs, branding, cornered resource, and process power --- each a structural property that sustains the ROIC--WACC spread.
