% figures-es/growth-loop.tex
% Standalone TikZ: un ciclo de growth autorreforzante (ch.08).
...
\begin{tikzpicture}[
  ...
  \node[stage] (cust)  {Clientes};
  \node[stage, right=28mm of cust] (out) {Referencias /\\contenido / datos};
  \node[stage, below=16mm of $(cust)!0.5!(out)$] (new) {Nuevos clientes};

  \draw[flow] (cust.east) -- node[above, font=\scriptsize\sffamily, text=black!55] {generan} (out.west);
